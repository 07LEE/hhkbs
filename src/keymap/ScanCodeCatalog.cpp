...
std::vector<ScanCodeEntry> makeEntries()
{
    ...
    const std::array<ScanCodeEntry, 46> studioFunctions{{
        ...
        {0x00B0, "Eject", "Media"},
        {0x00F0, "Mouse Cursor Up", "Mouse"},
        {0x00F1, "Mouse Cursor Down", "Mouse"},
        {0x00F2, "Mouse Cursor Left", "Mouse"},
        {0x00F3, "Mouse Cursor Right", "Mouse"},
        {0x00F4, "Mouse Left Click", "Mouse"},
        {0x00F5, "Mouse Wheel Click", "Mouse"},
        {0x00F6, "Mouse Right Click", "Mouse"},
        {0x00F9, "Wheel Up", "Mouse"},
        {0x00FA, "Wheel Down", "Mouse"},
        {0x00FB, "Wheel Left", "Mouse"},
        {0x00FC, "Wheel Right", "Mouse"},
        {0x5F80, "Left Side Pad On", "HHKB Studio"},
        {0x5F81, "Front Left Pad On", "HHKB Studio"},
        {0x5F82, "Front Right Pad On", "HHKB Studio"},
        {0x5F83, "Right Side Pad On", "HHKB Studio"},
        {0x5F84, "Left Side Pad Off", "HHKB Studio"},
        {0x5F85, "Front Left Pad Off", "HHKB Studio"},
        {0x5F86, "Front Right Pad Off", "HHKB Studio"},
        {0x5F87, "Right Side Pad Off", "HHKB Studio"},
        {0x5F88, "Toggle Left Side Pad", "HHKB Studio"},
        {0x5F89, "Toggle Front Left Pad", "HHKB Studio"},
        {0x5F8A, "Toggle Front Right Pad", "HHKB Studio"},
        {0x5F8B, "Toggle Right Side Pad", "HHKB Studio"},
        {0x5F8C, "Previous Window", "Window Switching"},
        {0x5F8D, "Next Window", "Window Switching"},
        {0x5F8E, "Previous Window (macOS)", "Window Switching"},
        {0x5F8F, "Next Window (macOS)", "Window Switching"},
        {0x5F90, "Pointing Stick On", "HHKB Studio"},
        {0x5F91, "Pointing Stick Off", "HHKB Studio"},
        {0x5F92, "Toggle Pointing Stick", "HHKB Studio"},
        {0x5F93, "Mouse Keys On", "HHKB Studio"},
        {0x5F94, "Mouse Keys Off", "HHKB Studio"},
        {0x5F95, "Toggle Mouse Keys", "HHKB Studio"},
